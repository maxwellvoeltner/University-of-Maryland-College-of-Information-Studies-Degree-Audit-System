...
title_label = Label(root, text = "Welcome to the UMD College of Information Studies Degree Audit")
title_label.grid(row = 0, column = 0)
majors_label = Label(root, text = "---Select Major---")
...
majors_menu = OptionMenu(root, major, "Information Science", "Social Data Science", "Technology and Information Design")
majors_menu.grid(row = 2, column = 0)


semester_label = Label(root, text = "Courses Credited Before Starting UMD")
semester_label.grid(row = 4, column = 0)
course_text_box = Text(root, height= 10, width = 50)
...
submit_semester_button = Button(text = "Submit Courses", command = submit_courses_click).grid(row = 6, column = 0)
submit_graduation_plan_button = Button(text = "Submit Graduation Plan", command = submit_graduation_plan_click).grid(row = 7, column = 0)
